...
<template>
  ...
  <div class="flex-row">
    <div>
      ...
      <select v-model="setCode">
        <option disabled hidden selected value="">Choisir un setCode</option>
        <option v-for="setCode in setCodes" :key="setCode" :value="setCode" @click="filterCards">
          {{ setCode }}
        </option>
      </select>
    ...
    <div>
      <input v-model="search" type="text" @input="searchCards"/>
  ...
  <div class="card-list">
    ...
    <div v-else>
      <div v-for="card in displayCards" :key="card.id" class="card">
